...
import { buildToolPreambleForProto, buildSchemaCompactToolPreambleForProto, buildSkinnyToolPreambleForProto, buildCompactToolPreambleForProto } from '../../src/chat-completions/tool-emulation.js';

const __dirname = dirname(fileURLToPath(import.meta.url));
const CLIENT_JS = readFileSync(join(__dirname, '..', '..', 'src/language-server/client.js'), 'utf8');
