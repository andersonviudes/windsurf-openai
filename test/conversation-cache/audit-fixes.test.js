...
import { writeJsonAtomic } from '../../src/core/fs-atomic.js';
import { cacheKey } from '../../src/conversation-cache/cache.js';
import { checkout, checkin, poolClear } from '../../src/conversation-cache/conversation-pool.js';
...
describe('atomic write call sites use writeJsonAtomic', () => {
  ...
  const FILES = [
    ...
    'src/core/stats.js',
    'src/core/proxy-config.js',
    'src/core/model-access.js',
  ];
